...
function Theme(options, ComposedComponent) {
  ...
  return _temp = _class = function (_ComposedComponent) {
    ...
    function _class(props, context, updater) {
      _classCallCheck(this, _class);

      var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(_class).call(this, props, context, updater));
    ...
    _createClass(_class, [{
      ...
      value: function getChildContext() {
        ...
        if (_get(Object.getPrototypeOf(_class.prototype), 'getChildContext', this)) return _extends({}, _get(Object.getPrototypeOf(_class.prototype), 'getChildContext', this).call(this), childContext);
        return childContext;
      }
    }, {
      ...
      value: function componentWillReceiveProps(nextProps, nextContext) {
        ...
        if (_get(Object.getPrototypeOf(_class.prototype), 'componentWillReceiveProps', this)) {
          return _get(Object.getPrototypeOf(_class.prototype), 'componentWillReceiveProps', this).call(this, nextProps, nextContext);
        }
      }
    }]);

    return _class;
  }(ComposedComponent), _class.propTypes = _extends({}, ComposedComponent.propTypes, {
    theme: _react.PropTypes.string
  }), _class.childContextTypes = _extends({}, ComposedComponent.childContextTypes, {
    theme: _react.PropTypes.string
  }), _class.contextTypes = _extends({}, ComposedComponent.contextTypes, {
    theme: _react.PropTypes.string
  }), _temp;
}