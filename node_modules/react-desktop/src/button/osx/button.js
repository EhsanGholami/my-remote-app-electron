...
var Button = (_dec = (0, _desktopComponent2.default)(_desktopComponent.WindowFocus, _desktopComponent.Hidden), _dec(_class = (_temp2 = _class2 = function (_Component) {
  ...
  function Button() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Button)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.isbutton = true, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['style', 'type', 'children', 'color', 'onClick']);

      var componentStyle = _extends({}, _osx10_2.default.button);
      if (color === 'blue' && this.state.windowFocused) {
        componentStyle = _extends({}, componentStyle, _osx10_2.default.blue);
      }
