...
var Radio = (_dec = (0, _desktopComponent2.default)(_desktopComponent.Hidden), _dec(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(Radio, [{
    ...
    value: function render() {
      ...
      var componentStyle = _extends({}, _osx10_2.default.radio, style);
      var labelStyle = _osx10_2.default.label;
      var shadowColor = '#0050a5';

      if (this.state.checked) {
        componentStyle = _extends({}, componentStyle, _osx10_2.default['radio:checked']);
      }

      if ((0, _radium.getState)(this.state, null, ':active')) {
        if (this.state.checked) {
          componentStyle = _extends({}, componentStyle, _osx10_2.default['radio:checked:active']);
          shadowColor = '#001d99';
        } else {
          componentStyle = _extends({}, componentStyle, _osx10_2.default['radio:active']);
        }
      }
