...
var ProgressCircle = (_dec = (0, _desktopComponent2.default)(_desktopComponent.Hidden), _dec(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(ProgressCircle, [{
    ...
    value: function render() {
      ...
      var containerStyle = _extends({}, _osx10_2.default.container);
      var componentStyle = _extends({}, _osx10_2.default.progress, style, {
        visibility: this.state.visible ? 'visible' : 'hidden',
        display: this.state.display ? 'block' : 'none'
      });

      if (absolute) {
        componentStyle = _extends({}, componentStyle, _osx10_2.default.absolute);
      }
