...
var _style10_ = require('../style/style10_11');

var _style10_2 = _interopRequireDefault(_style10_);
...
var Tab = (_dec = (0, _desktopComponent2.default)(_desktopComponent.WindowFocus), _dec(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var componentStyle = _extends({}, _style10_2.default.tab, style);

      if (firstChild) componentStyle = _extends({}, componentStyle, _style10_2.default.firstChild);
      if (lastChild) componentStyle = _extends({}, componentStyle, _style10_2.default.lastChild);

      if (prevSelected) componentStyle = _extends({}, componentStyle, _style10_2.default.prevSelected);
      if (afterSelected) componentStyle = _extends({}, componentStyle, _style10_2.default.afterSelected);

      if (this.props.selected) {
        componentStyle = _extends({}, componentStyle, _style10_2.default.selected);
        if (!this.state.windowFocused) componentStyle = _extends({}, componentStyle, _style10_2.default.selectedUnfocused);
        if (firstChild) componentStyle = _extends({}, componentStyle, _style10_2.default.firstChildSelected);
        if (lastChild) componentStyle = _extends({}, componentStyle, _style10_2.default.lastChildSelected);
      }
