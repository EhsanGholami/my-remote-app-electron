...
var Window = (_dec = (0, _desktopComponent2.default)(_desktopComponent.WindowFocus, (0, _desktopComponent.Dimension)('100vw', '100vh'), _desktopComponent.Alignment, _desktopComponent.Padding, _desktopComponent.Hidden, _desktopComponent.Background), _dec(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(Window, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['style', 'chrome']);

      var componentStyle = _extends({}, _osx10_2.default.window, style);
      if (chrome) {
        componentStyle = _extends({}, componentStyle, _osx10_2.default.chrome);

        if (!this.state.windowFocused) {
          componentStyle = _extends({}, componentStyle, _osx10_2.default.unfocused);
        }
      }
      ...
      var contentStyle = _osx10_2.default.content;
      if (chrome) {
      ...
      var content = _react2.default.createElement(_view2.default, { ref: 'content', style: contentStyle }, children);
