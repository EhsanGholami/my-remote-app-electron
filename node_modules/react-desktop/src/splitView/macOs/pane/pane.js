...
var Pane = (_dec = (0, _macOs2.default)(), _dec(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(Pane, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['children', 'style', 'defaultWidth']);

      var componentStyle = _extends({}, _2.default.pane);
      if (defaultWidth) {
        componentStyle.width = (0, _styleHelper.parseDimension)(defaultWidth);
      }

      return _react2.default.createElement('div', _extends({ style: _extends({}, componentStyle, style) }, props), children);
    }
  }]);

  return Pane;
}(_react.Component), _class2.propTypes = _extends({}, _macOs.backgroundPropTypes, {
  defaultWidth: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number])
}), _temp)) || _class);
