...
var SplitView = (_dec = (0, _dimension2.default)(), _dec(_class = (_temp = _class2 = function (_Component) {
  _inherits(SplitView, _Component);

  function SplitView() {
    _classCallCheck(this, SplitView);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(SplitView).apply(this, arguments));
  }
  ...
  _createClass(SplitView, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', _extends({ style: _extends({}, _2.default.container, style) }, props), children);
    }
  }]);

  return SplitView;
}(_react.Component), _class2.propTypes = _extends({}, _dimension.dimensionPropTypes), _temp)) || _class);
