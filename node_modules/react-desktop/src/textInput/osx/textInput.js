...
var _osx10_ = require('./styles/osx10_11');

var _osx10_2 = _interopRequireDefault(_osx10_);

var _label = require('../../label/osx/label');
...
var animation = (0, _radium.keyframes)({
  '0%': {
    opacity: '0',
    borderWidth: '34px',
    top: '-34px',
...
var TextFieldOSX = (_dec = (0, _desktopComponent2.default)(_desktopComponent.PlaceholderStyle, _desktopComponent.Hidden, _desktopComponent.Dimension, _desktopComponent.Margin), _dec(_class = (_temp = _class2 = function (_Component) {
  _inherits(TextFieldOSX, _Component);

  function TextFieldOSX() {
    _classCallCheck(this, TextFieldOSX);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(TextFieldOSX).apply(this, arguments));
  }

  _createClass(TextFieldOSX, [{
    key: 'getPlaceholderStyle',
    value: function getPlaceholderStyle() {
      return _osx10_2.default.textField[':placeholder'];
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['style', 'width', 'label', 'margin']);

      var componentStyle = _extends({}, style, _osx10_2.default.textField);

      var focusElement = void 0;
      if ((0, _radium.getState)(this.state, 'element', ':focus')) {
        var focusElementStyle = _extends({}, _osx10_2.default.focusElement, {
      ...
      return _react2.default.createElement('div', _extends({ style: _osx10_2.default.container }, { width: width, margin: margin }), labelComponent, _react2.default.createElement('div', { style: _osx10_2.default.wrapper }, _react2.default.createElement(_radium.StyleRoot, null, focusElement), _react2.default.createElement('input', _extends({
        key: 'element',
        ref: 'element',
        type: 'text',
