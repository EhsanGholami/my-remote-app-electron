...
var Box = (_dec = (0, _desktopComponent2.default)(_desktopComponent.Dimension, _desktopComponent.Margin, _desktopComponent.Padding, _desktopComponent.Alignment, _desktopComponent.Hidden, _desktopComponent.Background), _dec(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(Box, [{
    ...
    value: function render() {
      ...
      var componentStyle = _extends({}, _osx10_2.default.box, style);
      if (hasSegmentedControls) {
        componentStyle = _extends({}, _osx10_2.default.segmentedControls);
      }
      ...
      if (label) {
        return _react2.default.createElement('div', _extends({ style: _osx10_2.default.wrapper }, props), _react2.default.createElement(_text2.default, { margin: '0 0 1px 7px', size: 11 }, label), _react2.default.createElement('div', {
          ref: 'box',
          style: componentStyle
        }, children));
      }
      componentStyle = _extends({}, _osx10_2.default.wrapper, componentStyle);
